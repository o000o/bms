                    ...
                    if (succeed) { //contract inserted
                        ...
                        if (util.isDataFound(tempAgent)) {
                            ...
                            asyncTasks.push((callback) => {
                                mContractAgent.bulkCreate(cloneAgent, {
                                    validate: true
                                }).then((succeed) => {
            ...
            if (util.isDataFound(req.body.requestData) && util.isDataFound(req.body.requestData.contractId) && util.isDataFound(req.body.requestData.urId)) {
                ...
                if (util.isDataFound(asyncTasks)) {
                    ...
                    async.parallel(asyncTasks, () => { // All tasks are done now
                        ...
                        if (edit.countError) {
                            logger.error(req, cmd + '|Error while run asyncTasks|')
                            if (edit.contractUpdateError && edit.locationUpdateError && (edit.areaUpdateError || edit.areaDeleteError || edit.areaInsertError)) {
                            ...
                            } else if (edit.contractUpdateError && (edit.areaUpdateError || edit.areaDeleteError || edit.areaInsertError)) {
                                if (!edit.areaUpdateError && edit.areaDeleteError && !edit.areaInsertError) {
                            ...
                            } else if (edit.locationUpdateError && (edit.areaUpdateError || edit.areaDeleteError || edit.areaInsertError)) {
                                if (!edit.areaUpdateError && edit.areaDeleteError && !edit.areaInsertError) {
                    ...
                    asyncTasks.push((callback) => {
                        ...
                        mUR.update({
                            ...
                            if (util.isDataFound(succeed)) {
                                ...
                                edit.editResults.push({
                                    urId: req.body.requestData.urId,
                                    editStatus: 'Update Error:' + succeed
                                })
                            }
                            callback()
                        }).catch((err) => {
        ...
        try {
            ...
            if (util.isDataFound(req.body)) {
                ...
                if (util.isDataFound(req.body.requestData.vendorCriteria)) {
                    ...
                    if (util.isDataFound(req.body.requestData.vendorCriteria.where)) {
                      required = true
                    }
                } else {
                ...
                mContract.findAndCountAll(jWhere).then((db) => {
                    ...
                    if (db.count > 0) resp.getSuccess(req, res, cmd, {
