...
const mCtPayment = mCfg.sequelize.define('contract_payment', {
	...
	priceIncVat: {type: Sequelize.DECIMAL, field:'price_inc_vat', allowNull: true},
	priceIncWht: {type: Sequelize.DECIMAL, field:'price_inc_wht', allowNull: true},
	totalPrice: {type: Sequelize.DECIMAL, field:'total_price', allowNull: true},
	paymentPeriod: {type: Sequelize.STRING, field: 'payment_period', allowNull: true},
	paymentDate: {type: Sequelize.INTEGER, field: 'payment_date', allowNull: true},
